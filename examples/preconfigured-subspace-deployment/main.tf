...
module "vpn" {
  ...
  # this will cause terraform to generate an initial, valid subspace config, preventing the deployment to be exposed to the web
  admin_user_email         = "admin@example.com"
  generate_subspace_config = true
}
